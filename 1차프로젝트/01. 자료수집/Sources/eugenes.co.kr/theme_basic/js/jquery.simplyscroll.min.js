...
!function(s) {
    ...
    $.simplyScroll = function(s, t) {
        ...
        this.isHorizontal = null !== this.o.orientation.match(/^horizontal|vertical$/) && this.o.orientation === h.orientation,
        this.isRTL = this.isHorizontal && "rtl" === $("html").attr("dir"),
        this.isForwards = !this.isAuto && !this.isRTL || this.isAuto && null !== this.o.direction.match(/^forwards|backwards$/) && this.o.direction === h.direction,
        ...
        if (this.$list.addClass("simply-scroll-list").wrap('<div class="simply-scroll-clip"></div>').parent().wrap('<div class="' + this.o.customClass + ' simply-scroll-container"></div>'),
        this.isAuto ? this.o.pauseButton && (this.$list.parent().parent().prepend('<div class="simply-scroll-btn simply-scroll-btn-pause"></div>'),
        this.o.pauseOnHover = !1) : this.$list.parent().parent().prepend('<div class="simply-scroll-forward"></div>').prepend('<div class="simply-scroll-back"></div>'),
        1 < o.length) {
            var e = !1
              , a = 0;
            ...
            e && (this.$list = this.$list.wrap("<div></div>").parent().addClass("simply-scroll-list"),
            this.isHorizontal ? this.$list.children().css({
                float: "left",
                width: a + "px"
    ...
    $.simplyScroll.fn.extend({
        init: function() {
            ...
            this.isHorizontal ? (this.itemMax = this.$items.eq(0).outerWidth(!0),
            this.clipMax = this.$clip.width(),
            this.dimension = "width",
            this.moveBackClass = "simply-scroll-btn-left",
            this.moveForwardClass = "simply-scroll-btn-right",
            this.scrollPos = "Left") : (this.itemMax = this.$items.eq(0).outerHeight(!0),
            ...
            if (this.isAuto && "loop" === this.o.autoMode ? (this.$list.css(this.dimension, this.posMax + this.itemMax * s + "px"),
            this.posMax += this.clipMax - this.o.speed,
            this.isForwards ? (this.$items.slice(0, s).clone(!0).appendTo(this.$list),
            this.resetPosition = 0) : (this.$items.slice(-s).clone(!0).prependTo(this.$list),
            this.resetPosition = this.$items.length * this.itemMax,
            this.isRTL && (this.$clip[0].dir = "ltr",
            this.$items.css("float", "right")))) : this.isAuto || "loop" !== this.o.manualMode ? (this.$list.css(this.dimension, this.posMax + "px"),
            this.isForwards ? this.resetPosition = 0 : (this.resetPosition = this.$items.length * this.itemMax,
            this.isRTL && (this.$clip[0].dir = "ltr",
            this.$items.css("float", "right")))) : (this.posMax += this.itemMax * s,
            this.$list.css(this.dimension, this.posMax + this.itemMax * s + "px"),
            this.posMax += this.clipMax - this.o.speed,
            this.$items.slice(0, s).clone(!0).appendTo(this.$list),
            this.$items.slice(-s).clone(!0).prependTo(this.$list),
            this.resetPositionForwards = this.resetPosition = s * this.itemMax,
            ...
            this.funcMoveBack = function(s) {
                ...
                e.isAuto ? e.isForwards ? e.moveBack() : e.moveForward() : e.moveBack()
            }
            ,
            this.funcMoveForward = function(s) {
                s !== t && s.preventDefault(),
                e.trigger = e.isAuto || "end" !== e.o.manualMode ? null : this,
                e.isAuto ? e.isForwards ? e.moveForward() : e.moveBack() : e.moveForward()
            }
            ,
            ...
            this.isAuto) {
                function i() {
                    return !1 === e.paused ? (e.paused = !0,
                    e.funcMovePause()) : (e.paused = !1,
                    e.funcMoveResume()),
                    e.paused
                }
                if (this.paused = !1,
                ...
                this.isAuto && this.o.pauseOnHover && !this.supportsTouch)
                    ...
                    this.o.pauseButton && (this.$btnPause = $(".simply-scroll-btn-pause", this.$container).bind("click", function(s) {
                        s.preventDefault(),
                        i() ? $(this).addClass("active") : $(this).removeClass("active")
                    }));
                ...
                "end" === this.o.manualMode && (this.isRTL ? this.$btnForward.addClass("disabled") : this.$btnBack.addClass("disabled"))
        },
        moveForward: function() {
            ...
            var o = function(s) {
                if (i.$clip[0]["scroll" + i.scrollPos] < i.posMax - i.clipMax) {
                    ...
                    i.isLoop ? i.resetPos() : i.moveStop(i.movement);
                i.timestamp = s,
                i.interval = requestAnimationFrame(o)
            };
        ...
        moveStop: function(s) {
            this.movePause(),
            (this.timestamp = null) !== this.trigger && (void 0 !== s && $(this.trigger).addClass("disabled"),
            this.trigger = null),
            this.isAuto && "bounce" === this.o.autoMode && ("forward" === s ? this.moveBack() : this.moveForward())
        },
        moveResume: function() {
